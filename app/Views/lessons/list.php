  ...
  <div class="row d-flex">
    ...
    <div class="row">
      <div class="d-flex justify-content-around">
        ...
        <a class="btn btn-primary btn-sm " href="<?php echo base_url('admin/courses'); ?>" role="button"><i class="fa fa-angle-left" aria-hidden="true"></i> Volver al listado de mundos</a>
      </div>
    </div>
